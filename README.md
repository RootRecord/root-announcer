...
1. Purchase / download `root-announcer-1.7.1.jar` from BuiltByBit (coming soon) or your licensed RootMC distribution channel.
...
| Releases (version notes) | https://github.com/RootRecord/root-announcer/releases |
