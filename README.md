...
RootMC rotating server announcements

| Field | Value |
|-------|-------|
| **Folder / artifact** | `root-announcer` |
| **Version** | `1.7.0` |
| **Bukkit name** | `Root-Announcer` |
| **Paper API** | `26.1` |
| **Author** | Root Record |
| **Website** | https://rootmc.net |
| **Main class** | `com.rootrecord.minecraft.rootannouncer.RootAnnouncerPlugin` |

## Install

1. Install **[Root-Core](https://github.com/RootRecord/root-core)** first (license/cloud spine for the suite).
2. Download `root-announcer-1.7.0.jar` from [Releases](https://github.com/RootRecord/root-announcer/releases) or the [plugin catalog](https://rootmc.net/plugins/).
3. Remove any older `root-announcer-*.jar` from `plugins/`.
...
.\build-with-server-jdk.bat :plugins:root-announcer:jar
```
...
| Command | Description |
|---------|-------------|
| `/rootannouncer` | RootMC announcer admin |
| `/announcer` | Toggle RootMC rotating announcements for yourself |
...
| This plugin page | https://rootmc.net/plugins/root-announcer/ |
...
| GitHub (this repo) | https://github.com/RootRecord/root-announcer |
| Releases | https://github.com/RootRecord/root-announcer/releases |
